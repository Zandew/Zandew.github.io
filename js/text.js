...
let mmwText = 'A fully functional music player and playlist builder with ability to recommend songs based on user\'s mood. MacOS app built using Swift.';
...
document.getElementById("mmwText").innerHTML = mmwText;
document.getElementById("pwText").innerHTML = pwText;