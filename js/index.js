...
function solutions() {
    document.getElementById("info").innerHTML = '<input type="Find a Problem" id="search-box" style="outline: none; width: 100px; height: 25px;"><input type="submit" value="Search" onclick="find()" style="height: 25px;">';
